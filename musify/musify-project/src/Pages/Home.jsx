...
// import { FaPlay, FaPause, FaStepForward, FaStepBackward, FaRandom, FaExpand, FaVolumeUp } from "react-icons/fa";
...
const Home = () => {
  const [setIsPlaying, setIsPlaying] = useState(false);
  ...
  const songs = [
    {
      ...
      title: "Idhazhin Oram",
      artist: "Anirudh",
      src: "./src/Idhazhin Oram (The Innocence of Love) - Anirudh Ravichander,.mp3",
      image: "./src/3.jpg",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      src: "./src/Vennilavu Saaral.mp3",
      image: "./src/Amaran.jpg",
    },
    {
      id: 5,
      title: "Lubber Panthu",
      artist: "Chillanjirukkiye",
      src: "./src/Chillanjirukkiye.mp3",
      image: "./src/Screenshot 2025-03-09 160238.png",
    },
    {
      id: 6,
      title: "Devara",
      artist: "Pathavaikum",
      src: "./src/Paththavaikkum.mp3",
      image: "./src/devara.jpg",
    },
    {
      id: 4,
      title: "Dragon",
      artist: "Vazhithunaiye",
      src: "./src/Vazhithunaiye.mp3",
      image: "./src/drangon.jpg",
    },
    {
      id: 7,
      title: "Aadukalam",
      artist: "Ayyayo",
      src: "./src/Ayyayo - G.V. Prakash Kumar, S. P. Balasubrahmanyam, S.P.B.mp3",
      image: "./src/ayyoyo.webp",
    },
    {
      id: 8,
      title: "NEEk",
      artist: "Golden Spaarow",
      src: "./src/Golden-Sparrow-MassTamilan.dev.mp3",
      image: "./src/neek.jpg",
    },
    {
      id: 9,
      ...
      src: "./src/Kannadi-Poove-MassTamilan.dev.mp3",
      image: "./src/retro.jpg",
    },
    {
      id: 10,
      title: "Kingston",
      artist: "Yelavalele",
      src: "./src/Yelavalele.mp3",
      image: "./src/Screenshot 2025-03-09 160446.png",
    },
    {
      id: 11,
      title: "Once more",
      artist: "Vaa Kannama",
      src: "./src/Vaa-Kannamma-MassTamilan.dev.mp3",
      image: "./src/vaa.jpg",
    },
    {
      id: 12,
      title: "Ayyogya",
      artist: "Kanne-Kanne",
      src: "./src/Kanne-Kanne-MassTamilan.org.mp3",
      image: "./src/ayogya.webp",
    },
    {
      id: 13,
      title: "Sema",
      artist: "Sandalee",
      src: "./src/Sandalee-MassTamilan.com.mp3",
      image: "./src/sandalee.jpg",
    },
    {
      id: 14,
      title: "Jilla",
      artist: "Kandaangi Kandaangi",
      src: "./src/Kandangi-Kandangi.mp3",
      image: "./src/jilla.jpg",
    },
    {
      id: 15,
      ...
      src: "./src/Megham_Karukatha_From_Thiruchitrambalam_Dhanush,_Anirudh_R.mp3",
      image: "./src/megam.jpg",
    },
  ];
  ...
  return (
    <div className="w-full h-[calc(100vh-70px)] flex">
      ...
      <aside className="w-60 h-screen bg-gray-900 text-white p-5 flex flex-col gap-5 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-900">
        ...
        <nav className="space-y-5">
          ...
          <p>
            <NavLink to="radio" className="cursor-pointer hover:text-gray-400">
              📻 Radio
            </NavLink>
          </p>
          <br />
          ...
          <nav className="text-sm">
            <ol className="list-none p-0 inline-flex">
              <li className="flex items-center">
                <a
                  href="./HomePages/HomeSidebarPages/MainPages/Home.jsx"
              ...
              <li className="flex items-center">
                <a
                  href="./HomePages/HomeSidebarPages/MainPages/NewReleases.jsx"
                  className="hover:text-cyan-300"
                >
                  New Releases
                </a>
